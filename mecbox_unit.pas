...
begin
  ...
  output_list.Clear;
       ...
       if templot_program=0 then program_str:='Templot2'
  else if templot_program=1 then program_str:='OpenTemplot'
  else program_str:='TemplotMEC';

  output_list.Add('DO NOT EDIT THIS FILE');
  output_list.Add('=====================');
  output_list.Add('template data - saved from '+program_str+' version '+FormatFloat('0.00',program_version/100)+version_build);
  ...
  if later_file=True
     then begin
            alert(1,'php/980    later  file   -   ( from  version  '+FormatFloat('0.00',loaded_version/100)+' )',
                   ...
                   +'|This version of Templot is  '+FormatFloat('0.00',program_version/100)
