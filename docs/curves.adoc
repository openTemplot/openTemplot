...
[stem]
++++
(r_{\cos}, r_{\sin}) = \widehat{(1, y')}
++++

We then want to rotate the end-point for the slew by the rotation angle, and look at just the y component which will give us the maximum value of the slew function 
