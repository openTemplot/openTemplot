...
function putdim(h_str:string; units:integer; p_str:string; m:extended;no_neg, no_ps, no_zero, zero_terminate:boolean):integer;
function getdims(head_str, help_str:string; calling_form:Tform; n_max:integer; var outdims:Toutdim):boolean;
...
begin
  ...
  with dims[n] do begin
    if orgdim=def_req then input_box.Text:='/ pre-set'
                      else begin
                             if (ABS(orgdim)>=max_rad_test) and (nops=False)
                                then input_box.Text:='/ straight'
                                else input_box.Text:=round_str(orgdim,dec_places);
                           end;
  end;//with
...
begin
  with data_entry_form do begin
    ...
    case n of
         ...
         0: init_box(n,input_box0);
         1: init_box(n,input_box1);
         2: init_box(n,input_box2);
         3: init_box(n,input_box3);
         4: init_box(n,input_box4);
         5: init_box(n,input_box5);
         6: init_box(n,input_box6);
         7: init_box(n,input_box7);

    end;//case
  end;//with

  with dims[n] do newdim:=orgdim;
end;
//______________________________________________________________________________
  ...
  with data_entry_form do begin
    ...
    if Showing=True
       then begin
              ...
              if n<>0 then with input_panel0 do begin BorderStyle:=bsNone; ParentColor:=True; Left:=8; Top:=Round(52*global_factor);  help_button0.Visible:=False; input_box0.Color:=$00ECECEC; input_spacer_label0.Color:=$00ECECEC; end;
              if n<>1 then with input_panel1 do begin BorderStyle:=bsNone; ParentColor:=True; Left:=8; Top:=Round(84*global_factor);  help_button1.Visible:=False; input_box1.Color:=$00ECECEC; input_spacer_label1.Color:=$00ECECEC; end;
              if n<>2 then with input_panel2 do begin BorderStyle:=bsNone; ParentColor:=True; Left:=8; Top:=Round(116*global_factor); help_button2.Visible:=False; input_box2.Color:=$00ECECEC; input_spacer_label2.Color:=$00ECECEC; end;
              if n<>3 then with input_panel3 do begin BorderStyle:=bsNone; ParentColor:=True; Left:=8; Top:=Round(148*global_factor); help_button3.Visible:=False; input_box3.Color:=$00ECECEC; input_spacer_label3.Color:=$00ECECEC; end;
              if n<>4 then with input_panel4 do begin BorderStyle:=bsNone; ParentColor:=True; Left:=8; Top:=Round(180*global_factor); help_button4.Visible:=False; input_box4.Color:=$00ECECEC; input_spacer_label4.Color:=$00ECECEC; end;
              if n<>5 then with input_panel5 do begin BorderStyle:=bsNone; ParentColor:=True; Left:=8; Top:=Round(212*global_factor); help_button5.Visible:=False; input_box5.Color:=$00ECECEC; input_spacer_label5.Color:=$00ECECEC; end;
              if n<>6 then with input_panel6 do begin BorderStyle:=bsNone; ParentColor:=True; Left:=8; Top:=Round(244*global_factor); help_button6.Visible:=False; input_box6.Color:=$00ECECEC; input_spacer_label6.Color:=$00ECECEC; end;
              if n<>7 then with input_panel7 do begin BorderStyle:=bsNone; ParentColor:=True; Left:=8; Top:=Round(276*global_factor); help_button7.Visible:=False; input_box7.Color:=$00ECECEC; input_spacer_label7.Color:=$00ECECEC; end;

                        //  extra PostMessage needed to ensure SetFocus with flashing caret (Delphi bug)...

              if n=0 then with input_panel0 do begin BorderStyle:=bsSingle; Color:=outlined_colour; Left:=7; Top:=Round(51*global_factor);  help_button0.Visible:=True; Visible:=True; input_box0.Color:=clWhite; input_spacer_label0.Color:=clWhite; input_box0.SetFocus; PostMessage(input_box0.Handle,WM_SETFOCUS,0,0); end;
              if n=1 then with input_panel1 do begin BorderStyle:=bsSingle; Color:=outlined_colour; Left:=7; Top:=Round(83*global_factor);  help_button1.Visible:=True; Visible:=True; input_box1.Color:=clWhite; input_spacer_label1.Color:=clWhite; input_box1.SetFocus; PostMessage(input_box1.Handle,WM_SETFOCUS,0,0); end;
              if n=2 then with input_panel2 do begin BorderStyle:=bsSingle; Color:=outlined_colour; Left:=7; Top:=Round(115*global_factor); help_button2.Visible:=True; Visible:=True; input_box2.Color:=clWhite; input_spacer_label2.Color:=clWhite; input_box2.SetFocus; PostMessage(input_box2.Handle,WM_SETFOCUS,0,0); end;
              if n=3 then with input_panel3 do begin BorderStyle:=bsSingle; Color:=outlined_colour; Left:=7; Top:=Round(147*global_factor); help_button3.Visible:=True; Visible:=True; input_box3.Color:=clWhite; input_spacer_label3.Color:=clWhite; input_box3.SetFocus; PostMessage(input_box3.Handle,WM_SETFOCUS,0,0); end;
              if n=4 then with input_panel4 do begin BorderStyle:=bsSingle; Color:=outlined_colour; Left:=7; Top:=Round(179*global_factor); help_button4.Visible:=True; Visible:=True; input_box4.Color:=clWhite; input_spacer_label4.Color:=clWhite; input_box4.SetFocus; PostMessage(input_box4.Handle,WM_SETFOCUS,0,0); end;
              if n=5 then with input_panel5 do begin BorderStyle:=bsSingle; Color:=outlined_colour; Left:=7; Top:=Round(211*global_factor); help_button5.Visible:=True; Visible:=True; input_box5.Color:=clWhite; input_spacer_label5.Color:=clWhite; input_box5.SetFocus; PostMessage(input_box5.Handle,WM_SETFOCUS,0,0); end;
              if n=6 then with input_panel6 do begin BorderStyle:=bsSingle; Color:=outlined_colour; Left:=7; Top:=Round(243*global_factor); help_button6.Visible:=True; Visible:=True; input_box6.Color:=clWhite; input_spacer_label6.Color:=clWhite; input_box6.SetFocus; PostMessage(input_box6.Handle,WM_SETFOCUS,0,0); end;
              if n=7 then with input_panel7 do begin BorderStyle:=bsSingle; Color:=outlined_colour; Left:=7; Top:=Round(275*global_factor); help_button7.Visible:=True; Visible:=True; input_box7.Color:=clWhite; input_spacer_label7.Color:=clWhite; input_box7.SetFocus; PostMessage(input_box7.Handle,WM_SETFOCUS,0,0); end;

              end
       else with input_panel0 do begin BorderStyle:=bsSingle; Color:=outlined_colour; Left:=7; Top:=Round(51*global_factor);  help_button0.Visible:=True; Visible:=True; input_box0.Color:=clWhite; input_spacer_label0.Color:=clWhite; ActiveControl:=input_box0; end; // not showing so init first line in readiness
...
procedure init_panel(n:integer; input_panel:TPanel; input_prompt_label,input_dims_label:TLabel; input_box:TEdit);     // get the info from putdim
...
begin
  for i:=0 to max_line do restore_input(i);
...
begin
  ...
  if dims_i>dims_i_c then run_error(65);
  ...
  with dims[dims_i] do begin
    ...
    case units of
            ...
            5: units_str:=' cm';
            6: units_str:=' feet';
            7: units_str:=' proto-feet';   // prototype feet.
            8: units_str:=' metres';
          else run_error(66);
    end;//case
...
begin
  with data_entry_form do begin
    ...
    if (calling_form=pad_form) and (info_show_i=1)
       then begin
              save_info:=True;                         //  so we can re-show if nec.
              pad_form.hide_info_menu_entry.Click;     //  and hide the info panel to avoid confusion.
            end
       else save_info:=False;
    ...
    for i:=0 to n_max do outdims[i]:=dims[i].orgdim;   // init return values
    ...
    repeat
      ...
      if ModalResult=mrOk
         then begin
                for n:=0 to n_max do outdims[n]:=dims[n].newdim;   // return new values.
                RESULT:=True;
                BREAK;
              end
         else begin
                if cancel_entries_msg_pref=True
                   then i:=5
                   else begin
                          ...
                          i:=alert(7,'        cancel  all  entries ?',
                                    ...
                                    +' will cancel ALL your entries on the form, and restore ALL the previous settings.',
                                     '','','','','restore  previous  settings  and  close','continue  data  entry ...',0);
                   ...
                   if i=5
                      then begin
                             for n:=0 to n_max do outdims[n]:=dims[n].orgdim;  // restore old values.
                             RESULT:=False;
                             BREAK;
                           end;
              end;
  ...
  if save_info=True then pad_form.show_info_menu_entry.Click;        //  and the info panel.
  save_info:=False;                                                  //  for next time.

     // following needed to restore proper working   207a
     // if data-entry is done all on keyboard...

  if calling_form.Showing=True
     then begin
            if calling_form=pad_form
               then begin
...
begin
  ...
  if Key=VK_F1 then if more_info_button.Enabled=True then more_info_button.Click;
     ...
     then begin
            if jotter_form.Showing=True  // toggle
               then jotter_form.Close
                      ...
                      jotter_form.Show;
                      if jotter_form.Left<(Left+Width+10) then jotter_form.Left:=Left+Width+10;
                    end;
            Key:=0;
          end;
...
begin
  ...
  if (stay_visible_form.Showing=True) and ( stay_visible_form.Left<(Left+Width-8) )
     then begin
            Left:=0;
            stay_visible_form.Left:=Width-8;     // (=630) make sure it doesn't obscure us, otherwise can't continue (we always do BringToFront).
          end;
end;
//________________________________________________________________________________________
...
begin
  ...
  if ok_panel.Showing=True
     then begin
            if jot_always_checkbox.Checked=True then jot_all_button.Click;
...
begin
  ...
  if metric_form.Showing=True
     then metric_form.Close
     else begin
            metric_form.Show;
            if metric_form.Top<(Top+Height+10) then metric_form.Top:=Top+Height+10;  // ensure visible -- must be after showing the first time
          end;
...
begin
  if help(0,entry_help_str,'about  conversion  factors')=1 then show_factors_help;
  set_outlined_panel(current_line);
end;
...
begin
     putdim(a_str,0,'custom  input  conversion  factor  A  or  a',custom_input_factor1,True,True,True,False);  // no neg, no preset, no zero, don't terminate on zero.
     putdim(b_str,0,'custom  input  conversion  factor  B  or  b',custom_input_factor2,True,True,True,False);  // no neg, no preset, no zero, don't terminate on zero.
     putdim(c_str,0,'custom  input  conversion  factor  C  or  c',custom_input_factor3,True,True,True,False);  // no neg, no preset, no zero, don't terminate on zero.
  n:=putdim(d_str,0,'custom  input  conversion  factor  D  or  d',custom_input_factor4,True,True,True,False);  // no neg, no preset, no zero, don't terminate on zero.
     if n<>3 then EXIT;

     if getdims('custom  input  conversion  factors',more_str,control_room_form,n,od)=True   // called from program menu.
        then begin
               custom_input_factor1:=ABS(od[0]);    // negative factors not allowed to avoid confusion with [- when testing for invalid negatives.
...
const
  ...
  +'|---------------------------------'
  +'||For modellers of modern railways and for users in continental Europe and elsewhere where full-size information is frequently in metric units, and for users in the USA where model dimensions'
  +' are frequently in decimal or fractional inches, Templot0 also provides "input conversion factors".'
  +'||By prefixing your entered figures with a code letter, dimensions can be entered in any units of your choice.'
  +'||Here is a list of all the code letters available (widen this window for easier reading):'
  +'<SPAN STYLE="FONT-FAMILY:''Courier New'';">'
  +'|| CODE      DATA            IS'
   +'|LETTER:  ENTERED IN:   CONVERTED TO:               EXAMPLE:'
  +'|| m         mm            inches          sleeper width:  m250  =  9.843  inches  ( 250 mm)'
  +'|| f        feet           inches          sleeper length: f8.5  =   102   inches  ( 8ft-6in )'
 ...
 +'||| k    degrees         unit angle (RAM)   crossing angle: k9.5  =  1:5.98 RAM     (9.5 deg)'
  +'|| q  unit angle (CLM)  unit angle (RAM)   crossing angle: q7    =  1:6.96 RAM     (1:7 CLM)'
  +'|| n  unit angle (RAM)     degrees            rotation:    n6    =  9.46  degrees  ( 1:6   )'

  +'|| g    gradient %      unit angle (RAM)   crossing angle: g25   =  1:4            ( 25 %  )'
  +'</SPAN>'

  +'|||To use conversion factors with a negative dimension, the code letter must precede the minus sign. For example i-48 sets a radius to -1219.2mm. Note that in many cases a negative dimension is invalid.'
  +'||Conversion factors can also be combined.'
  +'|For example Templot0 expects the sleeper length to be entered in full-size prototype inches.'
  +' If you are using model sleepers 1.25 inches long you could enter this as si1.25'
  +'||The i prefix then converts the inches dimension to mm, and the s prefix converts model dimensions in mm to full-size inches.'
  +' So for 4mm/ft scale si1.25 = 95.25 inches full-size.'
  +'||Input conversion factors can be combined in any order and can be upper or lower case, so IS1.25 gives the same result.'

  +'||It is also possible to specify your own custom conversion factors for code letters a,b,c,d.'
  +' You can then use any units you choose.'
  +'||For example British prototype track radius dimensions are often quoted in chains (1 chain = 66 feet), whereas Templot0 expects the radius to be entered in the model size in mm (because it is nearly always underscale).'
  +'||If you set up custom conversion factors like this:'
  +'|A = 66'
  +'|B = 12'
  +'|you could enter a radius of 10 chains directly as PBA10. The A prefix converts chains to feet, the B prefix converts feet to inches, and the P prefix converts full-size inches to model mm.'
  +' So for 4mm/ft scale pba10 = 2640 mm radius on the model.'

  +'||To set the custom conversion factors select the PROGRAM > CUSTOM INPUT FACTORS... menu item on the PROGRAM PANEL menus.'

  +'||Important: The INPUT CONVERSIONS option box must be ticked for the above conversion factors to work.'
  +' Templot0 makes no check that the code letters used are appropriate for the units requested, since only you know what your figures represent.'
  +' The k , n , g , code letters are not valid in conjunction with the # symbol prefix to modify existing data.';
...
procedure input_box_exit(n:integer; input_panel:TPanel; input_prompt_label:TLabel; input_box:TEdit);
...
begin
  ...
  with data_entry_form do begin
    ...
    if ActiveControl=help_button0 then EXIT;
    if ActiveControl=help_button1 then EXIT;
    if ActiveControl=help_button2 then EXIT;
    if ActiveControl=help_button3 then EXIT;
    if ActiveControl=help_button4 then EXIT;
    if ActiveControl=help_button5 then EXIT;
    if ActiveControl=help_button6 then EXIT;
    if ActiveControl=help_button7 then EXIT;

    if ActiveControl=help_what_next_button  then EXIT;
    if ActiveControl=restore_all_button     then EXIT;
    if ActiveControl=restore_button         then EXIT;
    if ActiveControl=paste_button           then EXIT;
    if ActiveControl=metric_button          then EXIT;
    if ActiveControl=jot_all_button         then EXIT;
    if ActiveControl=jot_button             then EXIT;
    if ActiveControl=show_selected_checkbox then EXIT;
    if ActiveControl=jot_always_checkbox    then EXIT;
    if ActiveControl=full_fraction_checkbox then EXIT;
    if ActiveControl=conversions_checkbox   then EXIT;
    if ActiveControl=size_updown            then EXIT;
    if ActiveControl=blue_corner_panel      then EXIT;
    if ActiveControl=options_panel          then EXIT;
    if ActiveControl=more_info_button       then EXIT;
    if ActiveControl=cancel_button          then EXIT;
    if ActiveControl=ok_panel               then EXIT;
    if ActiveControl=ok_button              then EXIT;

    with dims[n] do begin

      intxt:=input_box.Text;
      if intxt='' then intxt:='0';           //  null input is zero

      intxt:=remove_space_str(intxt);        //  strip all spaces.
      if intxt='' then intxt:='0';           //  and then allow null as zero.
         ...
         then begin
                if nops=False                   //  preset allowed ?
                   then begin
                          ...
                          set_outlined_panel(current_line);    // return focus when form becomes active again
                ...
                repeat
                  brackpos:=Pos(']',intxt);                     //  remove any trailing bracket (clobbers conversion).
                  if brackpos>0 then Delete(intxt,brackpos,1);
                until brackpos=0;
                ...
                repeat                  // do all conversions
                  ...
                  in_char1:=intxt[1];   // first character might be a conversion factor code or negative...
                                        // multiply all the conversion factors and / or set the trig flags.

                  if (in_char1='[') or (in_char1='-')
                     then begin                         // either makes it neg.
                            Delete(intxt,1,1);
                            make_neg:=True;
                          end;


                  if conversions_checkbox.Checked=True
                     then case in_char1 of
                           ...
                           'h','H': begin                     //  h = sixteenths of inch input to mm
                                      Delete(intxt,1,1);
                           ...
                           'p','P': begin                     //  p = prototype inches input to model (scale) mm
                                      Delete(intxt,1,1);
                                      conv_factor:=conv_factor*inscale;
                                    end;

                           's','S': begin                     //  s = model (scale) mm input to prototytpe (full-size) inches
                                      Delete(intxt,1,1);
                                      conv_factor:=conv_factor/inscale;
                                    end;
                ...
                invalue:=invalue*ABS(conv_factor);    // do any conversions (factor is always +ve, non-zero).
                                                      // (must do his conversion immediately here so can do checks, redo displays valid input, etc.)

                if make_neg=True then invalue:=0-ABS(invalue);      //  ensure negative if no minus sign.

                try
                  if k_ram=True then invalue:=1/TAN(invalue*Pi/180);
                  if ram_k=True then invalue:=ARCTAN(1/invalue)*180/Pi;
                  if g_ram=True then invalue:=100/invalue;
                  if clm_ram=True then invalue:=1/TAN(2*ARCTAN(1/(2*invalue)));      // 216a  covert CLM units to RAM units
                except
                ...
                if modify_data_prefixed=True
                   then begin
                          if (k_ram=True) or (ram_k=True) or (g_ram=True) or (clm_ram=True)
                             then begin
                                    ...
                                    if invalue>max_rad_test then invalue:=max_rad;
                                    if invalue<(0-max_rad_test) then invalue:=0-max_rad;
                                    if ABS(invalue)<minfp then invalue:=0;
                                  end;
                        end;

                if (good_value=False) or ( (ABS(invalue)<minfp) and (nozero=True) ) or ( (invalue<0) and (noneg=True) )
                   then begin
                          ok_flag:=False;       //  invalid input characters, or zero or negative not allowed.

                          input_panel.Color:=$009999FF;      // red -- tell him.

                          if good_value=False
                             then show_modal_message('Invalid data was entered. Please try again or click ''restore''.')
                             else begin

                                    if (ABS(invalue)<minfp) and (nozero=True)
                                       then show_modal_message('This dimension can not be zero.');

                                    if (invalue<0) and (noneg=True)
                                       then show_modal_message('This dimension can not be negative.');
                   ...
                   else ok_flag:=True;    //  got valid input in invalue.
              end;
      ...
      if ok_flag=True     // set ouput data...
         then begin
                ...
                if (ABS(invalue-round_float(orgdim,dec_places))>minfp)     // return data only if modified
                or (data_entry_form.full_fraction_checkbox.Checked=True)   // 206e

                   then newdim:=invalue
                   else newdim:=orgdim;    //  this way cancels any rounding.

                if ABS(newdim-orgdim)<minfp
                   then input_box.Font.Color:=clBlack     //  no change.
                   else input_box.Font.Color:=clBlue;     //  new value entered.


                if ActiveControl=enter_button
                   then begin
                          if bottom_line=max_line
                             then begin
                                    ok_panel.Show;                     // covers enter button (which remains active)
                ...
                if ActiveControl=input_box0
                   then begin
                          set_outlined_panel(0);
                        end;

                if ActiveControl=input_box1
                   then begin
                          set_outlined_panel(1);
                        end;

                if ActiveControl=input_box2
                   then begin
                          set_outlined_panel(2);
                        end;

                if ActiveControl=input_box3
                   then begin
                          set_outlined_panel(3);
                        end;

                if ActiveControl=input_box4
                   then begin
                          set_outlined_panel(4);
                        end;

                if ActiveControl=input_box5
                   then begin
                          set_outlined_panel(5);
                        end;

                if ActiveControl=input_box6
                   then begin
                          set_outlined_panel(6);
                        end;

                if ActiveControl=input_box7
                   then begin
...
procedure Tdata_entry_form.input_box0Exit(Sender: TObject);     // CR  form enter_button Default=True
...
begin
  if data_entry_form.more_info_button.Enabled=True then f1_str:='more  general  information'
                                                   else f1_str:='';

  if help(0,dims[n].help_str,f1_str)=1 then data_entry_form.more_info_button.Click;
...
begin
  show_item_help(0);
  if input_panel0.Showing=True then input_box0.SetFocus;
end;
//______________________________________________________________________________
...
begin
  show_item_help(1);
  if input_panel1.Showing=True then input_box1.SetFocus;
end;
//______________________________________________________________________________
...
begin
  show_item_help(2);
  if input_panel2.Showing=True then input_box2.SetFocus;
end;
//______________________________________________________________________________
...
begin
  show_item_help(3);
  if input_panel3.Showing=True then input_box3.SetFocus;
end;
//______________________________________________________________________________
...
begin
  show_item_help(4);
  if input_panel4.Showing=True then input_box4.SetFocus;
end;
//______________________________________________________________________________
...
begin
  show_item_help(5);
  if input_panel5.Showing=True then input_box5.SetFocus;
end;
//______________________________________________________________________________
...
begin
  show_item_help(6);
  if input_panel6.Showing=True then input_box6.SetFocus;
end;
//______________________________________________________________________________
...
begin
  show_item_help(7);
  if input_panel7.Showing=True then input_box7.SetFocus;
end;
//______________________________________________________________________________
...
begin
  if data_entry_form.Showing=True then set_outlined_panel(current_line); // return focus
end;
//______________________________________________________________________________
...
begin
  ...
  if show_selected_checkbox.Checked then overwrite_checkbox.Checked:=False;    // 214a..
...
begin
  case current_line of
    ...
    0: with input_box0 do begin Clear; PasteFromClipboard; end;
    1: with input_box1 do begin Clear; PasteFromClipboard; end;
    2: with input_box2 do begin Clear; PasteFromClipboard; end;
    3: with input_box3 do begin Clear; PasteFromClipboard; end;
    4: with input_box4 do begin Clear; PasteFromClipboard; end;
    5: with input_box5 do begin Clear; PasteFromClipboard; end;
    6: with input_box6 do begin Clear; PasteFromClipboard; end;
    7: with input_box7 do begin Clear; PasteFromClipboard; end;
...
begin
  with jotter_form.jotter_memo.Lines do begin
    ...
    case current_line of
      ...
      0: Add(input_prompt_label0.Caption+' '+input_box0.Text+' '+input_dims_label0.Caption);
      1: Add(input_prompt_label1.Caption+' '+input_box1.Text+' '+input_dims_label1.Caption);
      2: Add(input_prompt_label2.Caption+' '+input_box2.Text+' '+input_dims_label2.Caption);
      3: Add(input_prompt_label3.Caption+' '+input_box3.Text+' '+input_dims_label3.Caption);
      4: Add(input_prompt_label4.Caption+' '+input_box4.Text+' '+input_dims_label4.Caption);
      5: Add(input_prompt_label5.Caption+' '+input_box5.Text+' '+input_dims_label5.Caption);
      6: Add(input_prompt_label6.Caption+' '+input_box6.Text+' '+input_dims_label6.Caption);
      7: Add(input_prompt_label7.Caption+' '+input_box7.Text+' '+input_dims_label7.Caption);
  ...
  if jotter_form.Showing=False then show_modal_message('A copy of the selected line of data has been added to the jotter.'
...
begin
  ...
  with jotter_form.jotter_memo.Lines do begin
    ...
    if current_line>0 then Add(input_prompt_label1.Caption+' '+input_box1.Text+' '+input_dims_label1.Caption);
    if current_line>1 then Add(input_prompt_label2.Caption+' '+input_box2.Text+' '+input_dims_label2.Caption);
    if current_line>2 then Add(input_prompt_label3.Caption+' '+input_box3.Text+' '+input_dims_label3.Caption);
    if current_line>3 then Add(input_prompt_label4.Caption+' '+input_box4.Text+' '+input_dims_label4.Caption);
    if current_line>4 then Add(input_prompt_label5.Caption+' '+input_box5.Text+' '+input_dims_label5.Caption);
    if current_line>5 then Add(input_prompt_label6.Caption+' '+input_box6.Text+' '+input_dims_label6.Caption);
    if current_line>6 then Add(input_prompt_label7.Caption+' '+input_box7.Text+' '+input_dims_label7.Caption);

    Add('_______________________');

  end;//with

  if jotter_form.Showing=False then show_modal_message('A copy of all visible lines of data have been added to the jotter.'
                                                +#13+#13+'Press CTRL+J to see the jotter.');
...
begin
  if data_entry_form.Showing=True then restore_all_button.Click;
end;
//______________________________________________________________________________
...
begin
   if (Sender is TCustomEdit) and (overwrite_checkbox.Checked=True) and (overwrite_checkbox.Enabled=True)
     then begin
